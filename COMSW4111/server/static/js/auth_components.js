        ...
        <div>
            <div className="flex flex-col items-center justify-center pt-4">
                <div className="w-1/2 px-20 mx-20">
                    <div
                        className="mx-30 bg-blue-500 rounded-3xl shadow dark:border dark:bg-gray-800 dark:border-gray-700 shadow-[1.0px_1.0px_7.0px_0.0px_rgba(0,0,0,0.58)]">
