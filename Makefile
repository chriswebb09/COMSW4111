...
lint:  ## run static analysis with flake8
	python -m black --check COMS4111 setup.py
	python -m flake8 COMS4111 setup.py

# Alias
lints: lint

format:  ## run autoformatting with black
	python -m black COMS4111/ setup.py
...
annotate:  ## run type checking
	python -m mypy ./COMS4111

#########
# TESTS #
#########
test: ## clean and run unit tests
	python -m pytest -v COMS4111/tests
